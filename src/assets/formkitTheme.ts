const textClassification = {
  ...
  inner: `
    ...
    `,
  input: "w-full p-2 border-none placeholder-gray-400",
}
...
const buttonClassification = {
  wrapper: "mb-1",
  input:
    "bg-green-600 hover:bg-green-700 text-white text-sm font-normal p-3 rounded-lg",
}
...
export default {
  ...
  file: {
    ...
    input:
      "text-gray-600 text-sm mb-1 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:bg-blue-500 file:text-white hover:file:bg-blue-600",
